...
def train():
    ...
    datamodule = data.TDTFiberPhotometryDataModule("/home/bugsie/PycharmProjects/FiberPhotometryAnalyzer/data",
    ...
    trainer = pl.Trainer(logger=wandb_logger, precision='16-mixed', max_time="00:01:00:00",
                         )
